package com.seehope.training.day11.myReflect;
...
public class TestReflect {
	...
	private static void m1() {
		String s = new String();
		Class c = s.getClass();
		System.out.println("String����ʵ����Class:"+c);//class java.lang.String
		Class su = c.getSuperclass();
		System.out.println("String����ʵ����Class��superClass:"+su);//class java.lang.Object
