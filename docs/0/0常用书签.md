...
* [icyfenix](http://icyfenix.cn/)
* [JavaFamily](https://gitee.com/sharehappy/JavaFamily)
* [JavaFamily_CSDN](https://aobing.blog.csdn.net/category_9424379.html)

### 腾讯云
* [实例控制台](https://console.cloud.tencent.com/lighthouse/instance/detail?rid=1&id=lhins-amwxl9pf)
* [IPC备案](https://console.cloud.tencent.com/beian/manage/material)
* [本地和云服务器怎么传文件](https://cloud.tencent.com/document/product/1207/53215)
### 阿里云
* [域名解析控制台](https://dns.console.aliyun.com/#/dns/setting/linzlb.fun)
...
* [思必驰](https://www.duiopen.com/docs/smarthome_overview)
...
* [EMQX企业版](https://docs.emqx.com/zh/enterprise/v4.2/development/protocol.html#mqtt%E5%8D%8F%E8%AE%AE)
* [IoT技术blog](https://blog.csdn.net/klandor2008)  
...
### 搭建SpringBoot项目常见的 Reference Documentation
* [homebrew](https://brew.sh/index_zh-cn)
* [linux安装mysql](https://blog.csdn.net/p445098355/article/details/124338426)
